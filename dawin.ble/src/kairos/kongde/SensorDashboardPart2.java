...
public class SensorDashboardPart2 {
	private Table table;
	...
	public void postConstruct(Composite parent) {
		...
		composite.setBounds(0, 0, 624, 395);
		...
		grpTotalSensor.setText("Sensor Summary");
		...
		tblclmnNewColumn_1.setText("Remark");
